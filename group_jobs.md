...
| ---------------- | ---------------- | -------------
| <a href="http://materialsvirtuallab.org/wiki/index.php?title=Cluster_Manager">Cluster Manager</a>  | - Purchases of new nodes<br>- Adding users to TSCC, XSEDE, NERSC, etc.<br>- Resolving problems (including VASP installation)<br>- Guide new users on usage of these resources<br>- Monitor resource usage.   | - Mahdi<br>- Ji
